...
const handleFacebookAuth = (req, res) => {
  const facebookURL = `https://www.facebook.com/v11.0/dialog/oauth?client_id=${process.env.FACEBOOK_APP_ID}&redirect_uri=${process.env.FACEBOOK_REDIRECT_URI}&scope=public_profile,email`;
